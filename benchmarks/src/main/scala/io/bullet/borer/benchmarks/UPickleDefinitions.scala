  ...
  implicit lazy val codec: ReadWriter[Product] = {
    val c = fileName match {
      ...
      case "github-events.json" =>
        implicit val _a = macroRW[GithubEvents.Actor]
        implicit val _b = macroRW[GithubEvents.Author]
        implicit val _c = macroRW[GithubEvents.Self]
        implicit val _d = macroRW[GithubEvents.Owner]
        implicit val _e = macroRW[GithubEvents.Org]
        implicit val _f = macroRW[GithubEvents.Links]
        implicit val _g = macroRW[GithubEvents.Links1]
        implicit val _h = macroRW[GithubEvents.Labels]
        implicit val _i = macroRW[GithubEvents.License]
        implicit val _j = macroRW[GithubEvents.Repo]
        implicit val _k = macroRW[GithubEvents.Repo1]
        implicit val _l = macroRW[GithubEvents.Comment]
        implicit val _m = macroRW[GithubEvents.Comment1]
        implicit val _n = macroRW[GithubEvents.Commits]
        implicit val _o = macroRW[GithubEvents.CreateEvent]
        implicit val _p = macroRW[GithubEvents.Forkee]
        implicit val _q = macroRW[GithubEvents.ForkEvent]
        implicit val _r = macroRW[GithubEvents.Head]
        implicit val _s = macroRW[GithubEvents.PullRequest]
        implicit val _t = macroRW[GithubEvents.PullRequest1]
        implicit val _u = macroRW[GithubEvents.PullRequest2]
        implicit val _v = macroRW[GithubEvents.PullRequestEvent]
        implicit val _w = macroRW[GithubEvents.PullRequestReviewCommentEvent]
        implicit val _x = macroRW[GithubEvents.Issue]
        implicit val _y = macroRW[GithubEvents.Issue1]
        implicit val _z = macroRW[GithubEvents.IssueCommentEvent]
        implicit val _A = macroRW[GithubEvents.IssuesEvent]
        implicit val _B = macroRW[GithubEvents.PushEvent]
        implicit val _C = macroRW[GithubEvents.WatchEvent]
        implicit val _D = macroRW[GithubEvents.RootInterface]
        ReadWriter.join[List[GithubEvents.RootInterface]](SeqLikeReader, SeqLikeWriter)
      ...
      case "reddit-scala.json" =>
        ...
        implicit val e = macroRW[Reddit.Data]
        implicit val f = macroRW[Reddit.Child]
        implicit val g = macroRW[Reddit.Data0]
        macroRW[Reddit.RootInterface]
