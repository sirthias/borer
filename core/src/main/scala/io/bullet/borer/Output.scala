...
import io.bullet.borer.output.{ToByteArrayOutput, ToByteBufferOutput, ToFileOutput}
...
object Output extends ToByteArrayOutput with ToByteBufferOutput with ToFileOutput {
