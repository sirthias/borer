...
lazy val benchmarks = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"        % "1.2.0",
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros"      % "1.2.0" % Provided,
