...
val `circe-core`    = Def.setting("io.circe"          %%% "circe-core"        % "0.14.12")
val `circe-parser`  = Def.setting("io.circe"          %%% "circe-parser"      % "0.14.12")
val `circe-generic` = Def.setting("io.circe"          %%% "circe-generic"     % "0.14.12")
