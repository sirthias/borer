...
val `pekko-actor`   = Def.setting("org.apache.pekko"  %%  "pekko-actor-typed" % "1.7.0")
val `pekko-stream`  = Def.setting("org.apache.pekko"  %%  "pekko-stream"      % "1.7.0")
...
lazy val site = project
  ...
  .settings(
    ...
    Compile / paradox / version := "1.18.0",
