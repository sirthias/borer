...
val `collection-compat` = Def.setting("org.scala-lang.modules" %%% "scala-collection-compat" % "2.1.4")
val `akka-actor`        = Def.setting("com.typesafe.akka"      %%  "akka-actor"              % "2.6.4")
val `akka-stream`       = Def.setting("com.typesafe.akka"      %%  "akka-stream"             % "2.6.4")
...
val `circe-derivation`  = Def.setting("io.circe"               %%% "circe-derivation"        % "0.13.0-M3")
...
lazy val benchmarks = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"        % "2.1.7",
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros"      % "2.1.7" % Provided,
