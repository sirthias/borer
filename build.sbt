...
val `akka-actor`        = Def.setting("com.typesafe.akka"      %%  "akka-actor"              % "2.6.6")
val `akka-stream`       = Def.setting("com.typesafe.akka"      %%  "akka-stream"             % "2.6.6")
val `akka-http`         = Def.setting("com.typesafe.akka"      %%  "akka-http"               % "10.1.12")
val `collection-compat` = Def.setting("org.scala-lang.modules" %%% "scala-collection-compat" % "2.1.6")
...
val `scodec-bits`       = Def.setting("org.scodec"             %%% "scodec-bits"             % "1.1.16")
...
lazy val benchmarks = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros"      % "2.4.0" % Provided,
