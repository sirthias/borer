...
val `pekko-actor`   = Def.setting("org.apache.pekko"  %%  "pekko-actor-typed" % "1.6.0")
val `pekko-stream`  = Def.setting("org.apache.pekko"  %%  "pekko-stream"      % "1.6.0")
val `pekko-http`    = Def.setting("org.apache.pekko"  %%  "pekko-http"        % "1.4.0")
val `cats-core`     = Def.setting("org.typelevel"     %%% "cats-core"         % "2.13.0")
val `circe-core`    = Def.setting("io.circe"          %%% "circe-core"        % "0.14.16")
val `circe-parser`  = Def.setting("io.circe"          %%% "circe-parser"      % "0.14.16")
val `circe-generic` = Def.setting("io.circe"          %%% "circe-generic"     % "0.14.16")
...
lazy val site = project
  ...
  .settings(
    ...
    Compile / paradox / version := "1.17.0",
