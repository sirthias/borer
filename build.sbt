...
val `akka-actor`        = Def.setting("com.typesafe.akka"      %%  "akka-actor"              % "2.6.8")
val `akka-stream`       = Def.setting("com.typesafe.akka"      %%  "akka-stream"             % "2.6.8")
...
val `scodec-bits`       = Def.setting("org.scodec"             %%% "scodec-bits"             % "1.1.18")
