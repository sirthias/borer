...
val `pekko-actor`   = Def.setting("org.apache.pekko"  %%  "pekko-actor-typed" % "1.2.1")
val `pekko-stream`  = Def.setting("org.apache.pekko"  %%  "pekko-stream"      % "1.2.1")
val `pekko-http`    = Def.setting("org.apache.pekko"  %%  "pekko-http"        % "1.3.0")
